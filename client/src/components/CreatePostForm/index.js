...
for (i = 0; i < l; i++) {
  ...
  for (j = 1; j < ll; j++) {
    ...
    c.addEventListener("click", function(e) {
      ...
      const category = document.getElementsByClassName("custom-select").value
    ...
    <div>
      <div className="jumbotron">
        <img
          ...
          src="https://prodimage.images-bn.com/pimages/9781608632442_p0_v1_s550x406.jpg"
        />
      </div>
...
<div className="custom-select">
  <select>
    ...
    <option value="3">Television/Film</option>
